        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border" >
              <a href="#issue" data-toggle="modal" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i> Request</a>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    $sql = "SELECT * FROM ISSUE_REQ LEFT JOIN BOOKS ON BOOKS.ISBN=ISSUE_REQ.ISBN LEFT JOIN BRANCH ON BRANCH.BRANCH_ID=BOOKS.BRANCH_ID WHERE ISSUE_REQ.USER_ID='$user[USER_ID]' $where";
                    $query = $set->query($sql);
                    while($row = $query->fetch_array()){
                      echo "
                        <tr>
                          ...
                          <td>".$row['REQ_DATE']."</td>
                          <td>
                            <button class='btn btn-danger btn-sm delete btn-flat' data-id='".$row['ISBN']."'><i class='fa fa-trash'></i> Cancel</button>
                          </td>
                        </tr>
                      ";
                    }
