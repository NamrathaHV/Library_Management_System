      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box " style="background-color: #9b9da2">
            <div class="inner">
              <?php
                $sql = "SELECT * FROM REGISTER WHERE USER_ID='$user[USER_ID]'";
                $query = $set->query($sql);
            ...
            <a href="book_read.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box " style="background-color: #800080bd; color: white;">
            <div class="inner">
              <?php
                $sql = "SELECT * FROM REGISTER WHERE RETURN_DATE IS NULL AND USER_ID='$user[USER_ID]'";
                $query = $set->query($sql);
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box " style="background-color: #9b9da2">
            <div class="inner">
              <?php
                $sql = "SELECT * FROM ISSUE_REQ WHERE USER_ID='$user[USER_ID]' ";
                $query = $set->query($sql);
